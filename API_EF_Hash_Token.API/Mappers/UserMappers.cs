...
namespace API_EF_Hash_Token.API.Mappers
{
    internal static class UserMappers
    {
        ...
        {
            return new UserDTO(model.UserId, model.FirstName, model.LastName, model.Email, model.PhoneNumber, model.Role, model.IsActive, model.Adresses?.Select(a => a.ToAdressDTO()).ToList());
